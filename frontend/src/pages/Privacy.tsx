      ...
      children={
        <Container>
          <Text typography="main">
            Qookie(이하 “회사”은 이용자의 개인정보 보호를 매우 중요하게 생각하며, 이용자가 회사의
            서비스를 이용하기 위해 회사에 제공한 개인정보 보호에 최선을 다하고 있습니다. 이에 회사는
            “개인정보 보호법" 등 정보통신서비스제공자가 준수하여야 하는 대한민국의 관계 법령 및
            개인정보보호규정, 가이드라인을 준수하고 있습니다. 본 개인정보처리방침은 Qookie
          ...
          <Text typography="main">
            ...
            비식별화되고 추적이 불가능한 고유 Key값을 통해서만 계정을 생성하며, 개인정보에 해당하는
            정보는 수집하지 않습니다. 회사는 회원이 탈퇴하거나, 처리 · 보유목적이 달성되거나
            보유기간이 종료한 경우 해당 개인정보를 지체 없이 파기합니다.
          </Text>
          <Divider />
          ...
          <Divider />
          <Title typography="button">제3조(정보주체와 법정대리인의 권리·의무 및 그 행사방법)</Title>
          <Text typography="main">
            ...
            6. 회사는 정보주체 권리에 따른 열람의 요구, 정정 · 삭제의 요구, 처리정지의 요구 시 열람
          ...
          <Text typography="main">
            ...
            개인정보처리방침이 변경되는 경우 회사는 변경 사항을 공지사항 등을 통해 게시하며, 변경된
            개인정보처리방침은 게시한 날로부터 7일 후부터 효력이 발생합니다. <br />
            공고일자: {latestUpdate}
            <br />
            시행일자: {latestStart}
          </Text>
